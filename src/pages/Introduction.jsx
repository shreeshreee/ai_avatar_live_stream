            ...
            <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
                ...
                <div className="flex flex-col justify-center">
                    ...
                    <div className="mx-auto my-3 flex w-full">
                        <a onClick={(e) => { localStorage.setItem('TAB', 'LIVE') }} class="mx-auto lg:mx-0 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-red-600 rounded-lg lg:w-auto hover:bg-red-500 focus:outline-none focus:bg-red-500 flex items-center" href="/live"><Dot className="h-10 w-10 animate-pulse" /><p className="mr-4">Watch Live</p></a>
                    </div>
                </div>
