    ...
    return (
        <div className=''>
            <div className="w-full py-[1rem] px-4 bg-white mx-auto">
                ...
                <h1 className="md:text-3xl sm:text-3xl text-2xl py-2 text-center my-2 ">Our Vision:</h1>
                <div id="scrollbar-chat" className='w-full  justify-center flex flex-wrap lg:p-0' >
                    <div className=" w-full border rounded-xl bg-white mb-4 p-2 md:p-4 lg:w-[30%] flex flex-col shadow-[0_5px_20px_1px_rgba(0,0,0,0.3)] ">
                        <h1 className="text-xl text-blue-800 font-semibold text-center lg:mb-7">Freedom from Human Bias:</h1>
                    ...
                    <div className=" w-full border rounded-xl bg-white mb-4 p-2 md:p-4 md:mx-4 lg:w-[30%] flex flex-col shadow-[0_5px_20px_1px_rgba(0,0,0,0.3)] ">
                        <h1 className="text-xl text-blue-800 font-semibold text-center">Comprehensive Coverage and Diverse Perspectives:</h1>
                        <div className="flex my-2 items-center px-5 py-0 rounded-[0_30px_30px_0] hover:transition-[0.3s]">
                            <div className="w-full mx-auto h-full rounded-[40px] bg-gradient-to-r from-violet-500 to-red-500">
                                <div className="h-[2px] bg-transparent rounded-[40px]"></div>
                            </div>
                    ...
                    <div className=" w-full border rounded-xl bg-white mb-4 p-2 md:p-4 lg:w-[30%] flex flex-col shadow-[0_5px_20px_1px_rgba(0,0,0,0.3)] ">
                        <h1 className="text-xl text-blue-800 font-semibold text-center lg:mb-7">A Glimpse into the Future:</h1>
                        <div className="flex my-2 items-center px-5 py-0 rounded-[0_30px_30px_0] hover:transition-[0.3s]">
                            <div className="w-full mx-auto h-full rounded-[40px] bg-gradient-to-r from-violet-500 to-red-500">
                                <div className="h-[2px] bg-transparent rounded-[40px]"></div>
                            </div>
